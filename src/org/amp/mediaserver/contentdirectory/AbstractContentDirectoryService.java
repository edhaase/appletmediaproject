...
/**
 * Modified AbstractContentDirectoryServer with RemoteClientInfo.
 */
...
public abstract class AbstractContentDirectoryService {
    ...
    final private static Logger log = Logger.getLogger(AbstractContentDirectoryService.class.getName());
    ...
    public BrowseResult search(
        ...
        try {
        	...
        	log.warning("Action failed: " + ex.toString());
            throw new ContentDirectoryException(ErrorCode.ACTION_FAILED, ex.toString());
        }
    }
    ...
    public BrowseResult search(String containerId, String searchCriteria, String filter,
                               ...
                               RemoteClientInfo clientInfo) throws ContentDirectoryException {
